                  ...
                  <FormField
                    ...
                    render={({ field, fieldState }) => (
                      <FormItem>
                        ...
                        >
                          Upload profile picture from your device.
                        </FormLabel>
                        <FormControl>
                          <div className="file-uploader flex justify-center">
                            <label className="custom-file-upload m-[10px] border border-border dark:bg-primary dark:text-secondary font-semibold bg-black text-primary">
                              <input
                                type="file"
                                accept="image/*"
