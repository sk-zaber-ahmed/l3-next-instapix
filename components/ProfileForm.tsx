...
function ProfileForm({
  ...
  return (
    <>
        ...
        <div className="flex justify-between items-center gap-x-2 md:gap-x-5 rounded-lg bg-zinc-100 dark:bg-neutral-800 p-2">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[12px] dark:text-neutral-500">
                {profile?.Email}
              </p>
            </div>
          </div>
          ...
          <div>
            {/* <button
              ...
              className="border border-border dark:bg-primary dark:text-secondary bg-black text-primary font-semibold text-sm cursor-pointer hover:text-white p-2 rounded-lg"
            >
              Change photo
            </button> */}
            <Button
              ...
              variant={"default"}
              //   className="border border-border dark:bg-primary dark:text-secondary bg-black text-primary font-semibold text-sm cursor-pointer  p-2 rounded-lg"
            >
              Change photo
            </Button>
          </div>
      ...
      {open && (
        <ProfileImageChange open={open} setOpen={setOpen}></ProfileImageChange>
      )}
    </>
  );
}
